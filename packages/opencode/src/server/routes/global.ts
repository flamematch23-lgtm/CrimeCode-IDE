...
export const GlobalRoutes = lazy(() =>
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        responses: {
          200: {
            ...
            content: {
              "application/json": {
                schema: resolver(z.object({ healthy: z.literal(true), version: z.string(), commit: z.string() })),
              },
            },
          },
        },
      ...
      async (c) => {
        return c.json({ healthy: true, version: Installation.VERSION, commit: Installation.COMMIT })
      },
    )
    .get(
      "/event",
