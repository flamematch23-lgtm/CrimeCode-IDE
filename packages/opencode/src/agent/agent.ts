      ...
      const state = yield* InstanceState.make<State>(
        Effect.fn("Agent.state")(function* (ctx) {
          ...
          const agents: Record<string, Info> = {
            ...
            pentester: {
              name: "pentester",
              description: `Offensive security agent for authorized penetration testing, vulnerability assessment, red team exercises, and phishing simulations. Performs reconnaissance, scanning, exploitation PoCs, credential attacks, phishing template generation, and structured reporting (PTES/OWASP WSTG). User has asserted authorization and ethical use responsibility.`,
