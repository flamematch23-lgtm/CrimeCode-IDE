...
import type {
  ...
  InviteCreateErrors,
  InviteCreateResponses,
  InviteListResponses,
  InviteRevokeErrors,
  InviteRevokeResponses,
  LiveshareKickErrors,
  LiveshareKickResponses,
  LiveshareParticipantsResponses,
  LiveshareStartResponses,
  LiveshareStatusResponses,
  LiveshareStopErrors,
  LiveshareStopResponses,
  LspStatusResponses,
  McpAddErrors,
  McpAddResponses,
...
export class Liveshare extends HeyApiClient {
  /**
   * Get live share status
   *
   * Get the current live share session status and participants.
   */
  public status<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    ...
    return (options?.client ?? this.client).get<LiveshareStatusResponses, unknown, ThrowOnError>({
      url: "/liveshare",
      ...options,
      ...params,
    })
   ...
   *
   * Start a new live share session as host.
   */
  public start<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    ...
    return (options?.client ?? this.client).post<LiveshareStartResponses, unknown, ThrowOnError>({
      url: "/liveshare/start",
      ...options,
      ...params,
      headers: {
   ...
   *
   * Stop the active live share session.
   */
  public stop<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<LiveshareStopResponses, LiveshareStopErrors, ThrowOnError>({
      url: "/liveshare/stop",
      ...options,
      ...params,
    })
   ...
   * Kick a participant
   *
   * Kick a participant from the live share session.
   */
  public kick<ThrowOnError extends boolean = false>(
    parameters: {
      id: string
      directory?: string
      workspace?: string
    ...
    return (options?.client ?? this.client).post<LiveshareKickResponses, LiveshareKickErrors, ThrowOnError>({
      url: "/liveshare/kick/{id}",
      ...options,
      ...params,
      headers: {
        "Content-Type": "application/json",
   ...
   * List participants
   *
   * List all participants in the active live share session.
   */
  public participants<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<LiveshareParticipantsResponses, unknown, ThrowOnError>({
      url: "/liveshare/participants",
      ...options,
      ...params,
    })
  }
...
export class Invite extends HeyApiClient {
   ...
   * List active invites
   *
   * List all active workspace invite codes.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    ...
    return (options?.client ?? this.client).get<InviteListResponses, unknown, ThrowOnError>({
      url: "/invite",
      ...options,
      ...params,
    })
  ...
  public create<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<InviteCreateResponses, InviteCreateErrors, ThrowOnError>({
      url: "/invite",
      ...options,
      ...params,
      headers: {
  ...
  public revoke<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).delete<InviteRevokeResponses, InviteRevokeErrors, ThrowOnError>({
      url: "/invite/{code}",
      ...options,
      ...params,
    })
...
export class OpencodeClient extends HeyApiClient {
  ...
  get liveshare(): Liveshare {
    return (this._liveshare ??= new Liveshare({ client: this.client }))
  }
