export const dict = {
  ...
  "dialog.provider.crimeopus.note": "CrimeCode AI gateway — 9 models (Default/Fast/Coder/Research/Reasoning/Agentic/Vision/Italian) via Together, Groq, RunPod failover. Set CRIMEOPUS_BASE_URL env var to point to your instance.",
  ...
  "dialog.invite.title": "Join with invite code",
  "dialog.invite.code": "Invite code",
  "dialog.invite.codePlaceholder": "ABCD-1234",
  "dialog.invite.relay": "Relay server",
  "dialog.invite.relayPlaceholder": "http://relay.example.com:3747",
  "dialog.invite.button": "Join workspace",
  "dialog.invite.joining": "Resolving...",
  "dialog.invite.error": "Invalid or expired invite code",
  "dialog.invite.success": "Connected to workspace",
  "dialog.invite.joinButton": "Join with code",
  ...
  "common.copyToClipboard.success": "{{label}} copied to clipboard",
  "common.copyToClipboard.error": "Failed to copy",
  "editor.menu.attachAsContext": "Attach as context",
  "editor.menu.copyContent": "Copy file content",
  "editor.menu.copyPath": "Copy path",
  "editor.menu.copyRelativePath": "Copy relative path",
  "editor.menu.copyName": "Copy file name",
  "editor.menu.openIn": "Open in",
  "editor.menu.openInVSCode": "VS Code",
  "editor.menu.openInExplorer": "Reveal in Explorer",
  "editor.menu.openInFinder": "Reveal in Finder",
  "editor.menu.openInFileManager": "Reveal in file manager",
  "editor.menu.fileContent": "File content",
  "editor.menu.relativePath": "Relative path",
  "editor.menu.path": "Path",
  "editor.menu.fileName": "File name",
  "editor.menu.desktopOnly": "Available only in the desktop app",
  "editor.menu.openFailed": "Failed to open file",
  "editor.menu.openWithFailed": "Failed to open with {{app}}",
  "editor.menu.revealFailed": "Failed to reveal in file manager",
  "common.key.esc": "ESC",
  ...
  "claudeCode.intro":
    "CrimeCode uses the locally-installed `claude` binary as a bridge to your Pro/Max subscription. Requests go through your subscription quota and don't consume paid API tokens.",
  "claudeCode.notInstalled.title": "Claude Code CLI not detected",
  "claudeCode.notInstalled.installFromPrefix": "Install the CLI from",
  "claudeCode.notInstalled.installFromSuffix": "and then run in a terminal:",
  "claudeCode.notInstalled.afterInstall":
    "After login, reopen this window: the provider will appear as connected automatically.",
  "claudeCode.notLoggedIn.title": "Claude CLI installed ({{version}}) but not logged in",
  "claudeCode.notLoggedIn.runInTerminal": "Run this command in a terminal:",
  "claudeCode.notLoggedIn.choose":
    'Pick your Pro/Max account. When "Logged in" appears, return here and reload.',
  "claudeCode.notLoggedIn.diagnostics": "Diagnostic details",
  "claudeCode.ready.title": "Ready",
  "claudeCode.ready.cliVersion": "CLI version:",
  "claudeCode.ready.account": "Account:",
  "claudeCode.ready.subscription": "Subscription:",
  "claudeCode.ready.auth": "Auth:",
  "claudeCode.ready.cost":
    "Cost per request: $0 (calls consume your subscription quota, not API tokens).",
  "claudeCode.ready.done": "Done",

  // Community page — strings added in v2.39+
  "community.telegram.banner": "Join the Telegram channel for releases, news and live changelog.",
  "community.telegram.openChannel": "Open channel",
  "community.telegram.dismiss": "Dismiss",
  "community.badge.modal.title": "New custom badge",
  "community.badge.modal.fileSelected": "File selected:",
  "community.badge.modal.nameLabel": "Badge name",
  "community.badge.modal.namePlaceholder": "e.g. Lucky Hunter",
  "community.badge.modal.descLabel": "Description (optional)",
  "community.badge.modal.descPlaceholder": "e.g. Found a 0day in <30 minutes",
  "community.badge.modal.cancel": "Cancel",
  "community.badge.modal.create": "Create badge",
  "community.badge.modal.uploading": "Uploading…",
  "community.badge.tooLarge.title": "Badge too large",
  "community.badge.tooLarge.description": "Max {{kb}} KB",
  "community.badge.uploadFailed": "Badge upload failed",
  "community.badge.created": 'Badge "{{label}}" created',
  "community.leaderboard.explainer.title": "How ranking works:",
  "community.leaderboard.explainer.body":
    "ordered by score in the period, then by total rep received, then by most recent activity. Score = sum of event weights: msg chat = 1, tool call = 1, session = 2, burp flow = 4, exploit chain = 5, report = 5, +rep received = 3. Give +rep (★) to users who help you to push them up — worth 3 pts in their score + 1 in their total rep counter.",

  // Burp Workspace / Security Toolkit
  "burp.title": "Burp Workspace",
  "burp.subtitle": "Integrated MITM proxy — intercept, repeater, intruder",
  "burp.tab.flows": "Flows",
  "burp.tab.intruder": "Intruder",
  "burp.tab.repeater": "Repeater",
  "burp.tab.rules": "Rules",
  "burp.tab.collaborator": "Collaborator",
  "burp.tab.settings": "Settings",
  "burp.status.connected": "Connected",
  "burp.status.disconnected": "Not connected",
  "burp.status.intercepting": "Intercepting",
  "burp.status.passthrough": "Passthrough",
  "burp.status.connecting": "Connecting…",
  "burp.status.givenUp": "Connection abandoned after too many retries.",
  "burp.action.startProxy": "Start proxy now",
  "burp.action.starting": "Starting…",
  "burp.action.retry": "Retry",
  "burp.action.testCapture": "Test capture",
  "burp.action.toggleIntercept": "Toggle intercept",
  "burp.action.purge": "Clear flows",
  "burp.empty.flows": "No flows captured. Configure your browser to use the proxy.",
  "burp.empty.pending": "No pending requests waiting for approval.",
  "burp.empty.rules": "No rules configured.",
  "burp.error.notRunning":
    'The Burp proxy is not running. Click "Start proxy now" or launch it manually.',
  "burp.error.notRunningHint":
    "The `burp-proxy-cli` binary is looked up in resources/. If missing, reinstall the app.",
  "burp.proxy.url": "Proxy URL",
  "burp.proxy.port": "Port",
  "burp.proxy.apiBase": "API base",
  "burp.proxy.cert.title": "CA certificate",
  "burp.proxy.cert.download": "Download CA root (.pem)",
  "burp.proxy.cert.howto":
    "To inspect HTTPS, import the CA cert into Chrome/Firefox/system, then configure the proxy.",
  "burp.flow.method": "Method",
  "burp.flow.url": "URL",
  "burp.flow.status": "Status",
  "burp.flow.timestamp": "Timestamp",
  "burp.flow.size": "Size",
  "burp.flow.empty": "Select a flow to see details.",
  "burp.testResult.passed": "Capture test OK ✓ — proxy is intercepting correctly.",
  "burp.testResult.failed": "Capture test failed ✗ — proxy is not intercepting.",

  // Builder modal — "New project" composer
  "builder.title": "What do you want to build?",
  "builder.subtitle":
    "Describe a project, an audit, or an investigation. The agent runs autonomously: plans, writes code, executes tools.",
  ...
  "builder.placeholder.pentest":
    "Target to test (URL/IP/domain) — confirm you are authorized to engage…",
  "builder.placeholder.exploit": "Vulnerabilities to chain into a working PoC…",
  "builder.placeholder.osint": "Person, company, domain, wallet to investigate…",
  "builder.placeholder.webapp": "Describe the full-stack web app you want built…",
  "builder.placeholder.api": "Describe the API: endpoints, auth, data model…",
  "builder.placeholder.mobile": "Describe the mobile app: features, platform, stack…",
  "builder.action.run": "Run agent",
  "builder.action.cancel": "Cancel",
  "builder.suggestions.label": "Examples",
  "builder.suggestions.refresh": "Refresh",
  "builder.suggestions.empty": "No examples available right now.",
  "builder.suggestions.loading": "Loading examples…",
  "builder.model.label": "Model",
