...
import { BrowserPreview, browserUrl, setBrowserUrl } from "@/components/browser-preview"
...
export function SessionSidePanel(props: {
  ...
  const hasBrowser = createMemo(() => platform.platform === "desktop" && !!browserUrl())

  // Auto-open review panel and activate browser tab when URL is set
  createEffect(() => {
