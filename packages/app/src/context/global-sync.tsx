...
function createGlobalSync() {
  ...
  async function bootstrapInstance(directory: string) {
    ...
    if (directory === "@liveshare") {
      ...
      child[1]("provider_ready", true)
      child[1]("mcp_ready", true)
      child[1]("lsp_ready", true)
      child[1]("project", "@liveshare")
      child[1]("path", {
        state: "",
        config: "",
        worktree: "@liveshare",
      ...
      child[1]("projectMeta", { name: "Live Share" })
      return
    }
  ...
  return {
    ...
    injectLiveEvent(event: { type: string; properties?: unknown }) {
      const dir = "@liveshare"
      const [store, setStore] = children.ensureChild(dir)
      children.mark(dir)
      applyDirectoryEvent({
        event,
        directory: dir,
