export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの CrimeCode を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "CrimeCode のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'crimecode' コマンドを使用してください。",
  ...
  "desktop.menu.help.documentation": "CrimeCode ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "CrimeCode CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
