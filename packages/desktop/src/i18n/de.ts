export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von CrimeCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von CrimeCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "CLI wurde in {{path}} installiert\n\nStarten Sie Ihr Terminal neu, um den Befehl 'crimecode' zu verwenden.",
  ...
  "desktop.menu.help.documentation": "CrimeCode-Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das CrimeCode CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
