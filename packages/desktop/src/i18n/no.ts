export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av CrimeCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av CrimeCode er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "CrimeCode Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "CrimeCode CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
