export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af CrimeCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af CrimeCode er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'crimecode'-kommandoen.",
  ...
  "desktop.cli.error.sidecarMissing": "CrimeCode CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
