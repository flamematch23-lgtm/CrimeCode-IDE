export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'CrimeCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'CrimeCode a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.cli.installed.message":
    "CLI installée dans {{path}}\n\nRedémarrez votre terminal pour utiliser la commande 'crimecode'.",
  ...
  "desktop.menu.help.documentation": "Documentation d'CrimeCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI CrimeCode est manquant. Essayez de réinstaller l'application de bureau.",
