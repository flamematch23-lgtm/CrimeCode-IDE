export const dict = {
  ...
  "desktop.menu.help.documentation": "CrimeCode Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of CrimeCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of CrimeCode has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the 'crimecode' command.",
  ...
  "desktop.cli.error.sidecarMissing": "CrimeCode CLI binary is missing. Try reinstalling the desktop app.",
