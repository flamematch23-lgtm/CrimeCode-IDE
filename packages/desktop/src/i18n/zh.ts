export const dict = {
  ...
  "desktop.updater.none.message": "你已经在使用最新版本的 CrimeCode",
  ...
  "desktop.menu.help.documentation": "CrimeCode 文档",
  ...
  "desktop.cli.error.sidecarMissing": "CrimeCode CLI 二进制文件缺失。请尝试重新安装桌面应用程序。",
