export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do CrimeCode",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do CrimeCode foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.cli.installed.message": "CLI instalada em {{path}}\n\nReinicie seu terminal para usar o comando 'crimecode'.",
  ...
  "desktop.menu.help.documentation": "Documentação do CrimeCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do CrimeCode está ausente. Tente reinstalar o aplicativo de desktop.",
