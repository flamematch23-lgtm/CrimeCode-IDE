export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji CrimeCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} CrimeCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'crimecode'.",
  ...
  "desktop.menu.help.documentation": "Dokumentacja CrimeCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego CrimeCode CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
