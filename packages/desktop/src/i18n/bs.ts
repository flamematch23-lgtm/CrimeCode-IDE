export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju CrimeCode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} CrimeCode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI je instaliran u {{path}}\n\nRestartuj terminal da bi koristio komandu 'crimecode'.",
  ...
  "desktop.menu.help.documentation": "CrimeCode Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka CrimeCode CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
