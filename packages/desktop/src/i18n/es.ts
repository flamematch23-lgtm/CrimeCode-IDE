export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de CrimeCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de CrimeCode. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.cli.installed.message": "CLI instalada en {{path}}\n\nReinicia tu terminal para usar el comando 'crimecode'.",
  ...
  "desktop.menu.help.documentation": "Documentación de CrimeCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de CrimeCode. Intenta reinstalar la aplicación de escritorio.",
