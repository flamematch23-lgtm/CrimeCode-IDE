export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من CrimeCode",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من CrimeCode، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق CrimeCode",
  ...
  "desktop.cli.error.sidecarMissing": "ملف CrimeCode CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
